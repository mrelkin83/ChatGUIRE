...
export default function SALogsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-bold text-[#8b5cf6]">Logs de AuditorÃ­a</h1>
      <div className="glass-card overflow-hidden">
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#252536] text-left text-xs font-semibold uppercase text-[#8b8b9e]">
              <th className="px-5 py-3">AcciÃ³n</th><th className="px-5 py-3">Tipo</th><th className="px-5 py-3">Fecha</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#252536]">
            ...
            {logs.length === 0 && (
              <tr><td colSpan={3} className="px-5 py-12 text-center text-sm text-[#8b8b9e]"><FileText className="h-6 w-6 mx-auto mb-2 text-[#5a5a6e]"/>Sin registros de auditorÃ­a</td></tr>
            )}
          </tbody>
        </table>
      </div>
